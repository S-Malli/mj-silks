...
const pillars = [
  {
    ...
    title: 'Heritage',
    description:
      'Rooted in the rich weaving traditions of Tamil Nadu, every Hello Silks saree carries forward generations of textile heritage.',
  },
  {
    icon: ShieldCheck,
    title: 'Quality',
...
export default function About() {
  return (
    <>
      <SEO
        title="About Us"
        description="Discover the story behind Hello Silks — our heritage, commitment to quality, craftsmanship and the trust we've built with thousands of customers."
        path="/about"
      />

      <section className="relative isolate overflow-hidden">
        <div className="absolute inset-0 -z-10">
          <img src={bannerImage} alt="Hello Silks craftsmanship" className="h-full w-full object-cover" />
